var Material = function () {
    return{
                ...
                success: function (data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $(".bs-modal-sm .btn-next").click(function () {
                            ...
                            Material.load_question_in_modal(data[currentPos + 1],currentPos+2,data.length);
                        ...
                        Material.load_question_in_modal(data[0],1,data.length);
        ...
        load_question_in_modal: function (obj,currentPos,total) {
            $.ajax({
